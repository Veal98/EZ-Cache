...
public interface IExpressionParser {
     ...
     * @throws Exception 异常
     */
    default boolean isCacheable(EzCache ezCache, Object target, Object[] args, Object retVal) throws Exception {
        boolean rv = true;
     ...
     * @throws Exception 异常
     */
    default String parseCacheKeyFromExpression(String exp, Object target, Object[] args, Object retVal, boolean hasRetVal) throws Exception {
     ...
     * @throws Exception 异常
     */
    <T> T parseExpression(String exp, Object target, Object[] args, Object retVal, boolean hasRetVal, Class<T> expValueType) throws Exception;
     ...
     * @throws Exception 异常
     */
    default <T> T parseExpression(String exp, Object target, Object[] args, Class<T> expValueType) throws Exception {
