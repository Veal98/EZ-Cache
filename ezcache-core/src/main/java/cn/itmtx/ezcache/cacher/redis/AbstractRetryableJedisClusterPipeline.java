...
public abstract class AbstractRetryableJedisClusterPipeline {
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractRetryableJedisClusterPipeline.class);
    ...
    public AbstractRetryableJedisClusterPipeline(JedisCluster jedisCluster) {
